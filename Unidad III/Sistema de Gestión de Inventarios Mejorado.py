...
class Producto:
    ...
    def to_linea(self):
        """
        Representación del producto en formato para guardar en archivo.
        """
    ...
    def from_linea(linea):
        """
        Crear un producto desde una línea del archivo.
        """
        try:
...
class Inventario:
    ...
    def cargar_desde_archivo(self):
        ...
        try:
            ...
            print("Inventario cargado desde archivo correctamente.")
        ...
        try:
            with open(self.archivo, "w", encoding="utf-8") as f:
                for p in self.productos:
                    f.write(p.to_linea())
            print("Inventario guardado en archivo correctamente.")
